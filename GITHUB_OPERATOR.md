...
```text
week-01-foundation
week-02-crawler-core
week-03-first-sources
week-04-scoring-loop
week-05-hardening
week-06-mvp-release
```
...
Each weekly or phase milestone should have a parent issue.
...
Each sub-issue must be executable.
...
Each milestone or weekly slice should normally produce one reviewable pull request.
